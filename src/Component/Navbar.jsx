...
export default function Navbar() {
  ...
  return (<>
    <div className='navbarHamza d-flex gap-2 justify-content-center'>
        <a href="https://hamza-nawabi.netlify.app" target='_blank'>
        <div className="logo btn p-2 me-4 mt-1">
            Developed By Hamza Nawabi
        </div>
        </a>
        <Link to='/'>
            <div className="web btn btn-outline-dark p-2" >
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-chat-left-text" viewBox="0 0 16 16">
        ...
        <Link to="/web">
        <div className="web btn btn-outline-dark p-2" >
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-browser-edge" viewBox="0 0 16 16">
